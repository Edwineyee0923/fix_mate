...
class s_ServiceRating extends StatefulWidget {
  final String postId;

  const s_ServiceRating({Key? key, required this.postId}) : super(key: key);

  @override
  _s_ServiceRatingState createState() => _s_ServiceRatingState();
}

class _s_ServiceRatingState extends State<s_ServiceRating> {
