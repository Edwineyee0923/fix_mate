...
class p_CBookingDetail extends StatefulWidget {
  final String bookingId;
  final String postId;
  final String seekerId;

  const p_CBookingDetail({
    Key? key,
  ...
  @override
  State<p_CBookingDetail> createState() => _p_CBookingDetailState();
}

class _p_CBookingDetailState extends State<p_CBookingDetail> {
