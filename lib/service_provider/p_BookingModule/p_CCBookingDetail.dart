...
class p_CCBookingDetail extends StatefulWidget {
  final String bookingId;
  final String postId;
  final String seekerId;

  const p_CCBookingDetail({
    Key? key,
  ...
  @override
  State<p_CCBookingDetail> createState() => _p_CCBookingDetailState();
}

class _p_CCBookingDetailState extends State<p_CCBookingDetail> {
