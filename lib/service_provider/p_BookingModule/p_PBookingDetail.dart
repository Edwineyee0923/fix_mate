...
class p_PBookingDetail extends StatefulWidget {
  ...
  @override
  State<p_PBookingDetail> createState() => _p_PBookingDetailState();
}

class _p_PBookingDetailState extends State<p_PBookingDetail> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (isRescheduling && !rescheduleSent) _buildRescheduleModal(),

            // Reschedule Confirmation Message
            if (rescheduleSent) _buildRescheduleConfirmationMessage(),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            "The previous schedule was not suitable for the service seeker.\nPlease discuss via WhatsApp and propose a new schedule below.",
                            style: TextStyle(
                              fontSize: 14,
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            foregroundColor: Color(0xFF464E65),
                            side: BorderSide(color: Color(0xFF464E65)),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(30),
                            ),
  ...
  Widget _buildRescheduleConfirmationMessage() {
    return Card(
      elevation: 4,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: Container(
        ...
        children: [
          ...
          if (bookingData?['isRescheduling'] == true) ...[
            _buildScheduleItem(
              ...
              "${_formatDate(bookingData!['finalDate'])}, ${_formatTime(bookingData!['finalTime'])}",
              isConfirmed: true,
            ),
          ] else ...[
            _buildScheduleItem(
              "Preferred Schedule",
              "${_formatDate(bookingData!["preferredDate"])}, ${_formatTime(bookingData!["preferredTime"])}",
              isPrimary: true,
            ),
            if (bookingData!["alternativeDate"] != null && bookingData!["alternativeTime"] != null)
              _buildScheduleItem(
                "Alternative Schedule",
                "${_formatDate(bookingData!["alternativeDate"])}, ${_formatTime(bookingData!["alternativeTime"])}",
              ),
          ],
        ],
      ),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 8,
            decoration: BoxDecoration(
              color: isConfirmed ? const Color(0xFF464E65) :
              isPrimary ? const Color(0xFF464E65) : const Color(0xFF95A5A6),
  ...
  Widget _buildStatusActionsSection() {
    if (isRescheduling) return Container();

    if (bookingData?['sCancelled'] == true) {
      return _buildCancellationCard();
    } else {
      return Column(
        children: [
          _buildScheduleConfirmationCard(),
          const SizedBox(height: 16),
  ...
  Widget _buildScheduleConfirmationCard() {
    return Card(
      elevation: 4,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: const [
                Icon(Icons.event_available, color: Color(0xFF464E65), size: 24),
                SizedBox(width: 12),
                Text(
                  "Confirm Schedule",
                  style: TextStyle(
            ...
            const Text(
              "Select your preferred schedule to confirm the booking:",
              style: TextStyle(
                fontSize: 14,
                color: Color(0xFF7F8C8D),
              ),
            ...
            _buildScheduleOption(
              "Preferred Schedule",
              "${_formatDate(bookingData!["preferredDate"])} at ${_formatTime(bookingData!["preferredTime"])}",
              'preferred',
            ),
            ...
            if (bookingData!["alternativeDate"] != null && bookingData!["alternativeTime"] != null)
              _buildScheduleOption(
                "Alternative Schedule",
                "${_formatDate(bookingData!["alternativeDate"])} at ${_formatTime(bookingData!["alternativeTime"])}",
                'alternative',
              ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text("Confirm Selected Schedule"),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF464E65),
                  foregroundColor: Colors.white,
  ...
  Widget _buildScheduleOption(String title, String dateTime, String value) {
    return Container(
      margin: const EdgeInsets.only(bottom: 12),
      decoration: BoxDecoration(
        border: Border.all(
          color: selectedSchedule == value ? const Color(0xFF464E65) : const Color(0xFFE9ECEF),
          width: 2,
        ),
        borderRadius: BorderRadius.circular(12),
      ),
      child: RadioListTile<String>(
        ...
        activeColor: const Color(0xFF464E65),
        onChanged: (val) {
          setState(() => selectedSchedule = val);
        },
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: const [
                Icon(Icons.schedule_send, color: Color(0xFF464E65), size: 24),
                SizedBox(width: 12),
                Text(
                  "Need to Reschedule?",
                  style: TextStyle(
            ...
            const Text(
              "If both schedules don't work for you, contact the seeker via WhatsApp or propose a new schedule.",
              style: TextStyle(
                fontSize: 14,
                color: Color(0xFF7F8C8D),
                height: 1.4,
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text("Propose New Schedule"),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF464E65),
                  foregroundColor: Colors.white,
                  padding: const EdgeInsets.symmetric(vertical: 16),
...
// Add reschedule UI and other existing methods here...
// [Include all your existing reschedule methods like _buildDateTimePicker, _selectDate, etc.]
  // Widget build(BuildContext context) {
  //   if (bookingData == null || instantPostData == null) {
  //     return const Scaffold(
  //       body: Center(child: CircularProgressIndicator()),
