...
class p_FilterInstantPost extends StatefulWidget {
  ...
  @override
  _p_FilterInstantPostState createState() => _p_FilterInstantPostState();
}

class _p_FilterInstantPostState extends State<p_FilterInstantPost> {
